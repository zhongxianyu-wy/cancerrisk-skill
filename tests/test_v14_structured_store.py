...
def test_detection_derived_engine_fields():
    d = json.loads((ES / "assertions/detection_performance_derived.json").read_text())
...
def test_priors_have_missing_list():
    d = json.loads((ES / "ontology/cancer_age_sex_priors.json").read_text())
...
def test_lynch_risk_factors_defined():
    ...
    d = json.loads((ES / "ontology/risk_factors.json").read_text())
...
def test_head_neck_screening_has_npc_ebv():
    ...
    d = json.loads((ES / "screening/screening_recommendations.json").read_text())
