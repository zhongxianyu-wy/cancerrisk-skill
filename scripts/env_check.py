...
REQUIRED_FIXTURES = tuple(str(_SKILL_ROOT / p) for p in (
    "config/formal.yaml",
    "config/contact.json",
    "evidence_store/ontology/cancers.json",
    "evidence_store/ontology/risk_factors.json",
    "evidence_store/ontology/cancer_age_sex_priors.json",
    "evidence_store/ontology/factor_synonyms.json",
    "evidence_store/assertions/risk_assertions_derived.json",
    "evidence_store/assertions/detection_performance_derived.json",
    "evidence_store/screening/screening_recommendations.json",
