...
EVIDENCE_STORE_DEFAULT = SKILL_ROOT / "evidence_store"
...
def main() -> None:
    ...
    cancers_ontology = store / "ontology/cancers.json"
    output = Path(args.output) if args.output else store / "ontology/cancer_age_sex_priors.json"
