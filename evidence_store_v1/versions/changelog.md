...
## evidence-v0003 — 2026-05-25

- DOR-calibrated OR values for tumor markers updated to Meta-analysis DOR-based values in `ontology/medical_indicators.md`.
  Key changes: AFP >200 OR 100→47.1, CEA >20 OR 100→20, CA19-9 >37 OR updated, CA125 >35 OR updated.
- Added `thyroid_cancer` (甲状腺癌) to `ontology/cancer_age_sex_priors.json` with GLOBOCAN-based incidence rates.
- Cancer count: 13→14.
- Source: database_new/evidence_store/ontology/ (independent validation set version).
